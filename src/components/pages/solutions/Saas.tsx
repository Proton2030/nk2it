...
export const Saas: React.FC = () => {
      ...
      case 'security':
        return (
          ...
          <div className="">
            ...
            >
              <a href="#_" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-gray-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700">
  ...
  <path d="M8 2a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 6.095 0 7.555 0 9.318 0 11.366 1.708 13 3.781 13h8.906C14.502 13 16 11.57 16 9.773c0-1.636-1.242-2.969-2.834-3.194C12.923 3.999 10.69 2 8 2m2.354 6.854-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 1 1 .708-.708L7.5 9.293V5.5a.5.5 0 0 1 1 0v3.793l1.146-1.147a.5.5 0 0 1 .708.708"/>
</svg><span className="relative text-sm">&nbsp;&nbsp;Sophos</span>
</a>
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-cloud-arrow-down-fill" viewBox="0 0 16 16">
  <path d="M8 2a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 6.095 0 7.555 0 9.318 0 11.366 1.708 13 3.781 13h8.906C14.502 13 16 11.57 16 9.773c0-1.636-1.242-2.969-2.834-3.194C12.923 3.999 10.69 2 8 2m2.354 6.854-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 1 1 .708-.708L7.5 9.293V5.5a.5.5 0 0 1 1 0v3.793l1.146-1.147a.5.5 0 0 1 .708.708"/>
</svg><span className="relative text-sm">&nbsp;&nbsp;ESET</span>
</a>
      ...
      case 'Ms':
        return (
          ...
          <div className="py-3">
            ...
            >
                         <a href="#_" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-gray-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700">
    <span className="relative text-sm">&nbsp;&nbsp;Microsoft Office 365</span>
</a>
            ...
            >
                    <a href="#_" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-gray-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700">
    <span className="relative text-sm">&nbsp;&nbsp;Microsoft Dynamics</span>
</a>
      ...
      case 'Backup':
        return (
          ...
          <div className="mx-auto">
            ...
            >
                   <a href="#_" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-gray-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700">
    <span className="relative text-sm">Veeam</span>
</a>
            ...
            >
                           <a href="#_" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-gray-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700">
    <span className="relative text-sm">Avepoint</span>
</a>
  ...
  const handleMsButtonClick = (_product: string) => {
    // Implement actions for Microsoft buttons
  };

  const handleBackupButtonClick = (_product: string) => {
...
<div className="flex h-screen">
  {/* <!-- Left Pane --> */}
  <div className="hidden pt-8 lg:flex items-center justify-center flex-1 bg-white text-black">
  ...
  <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
    ...
    <div>
      <div className="pt-16">
        <section className="flex gap-5  items-center font-poppins dark:bg-gray-800 ">
          <div
            
            onClick={() => handleCategoryClick('security')}
          >
            <a href="#_" className="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-blue-100 border border-gray-100 rounded-lg shadow-inner group">
...
<span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease">Security</span>
</a>
          </div>
          
          <button  onClick={() => handleCategoryClick('Ms')}>
          <a href="#_" className="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-blue-100 border border-gray-100 rounded-lg shadow-inner group">
<span className="absolute top-0 left-0 w-0 h-0 transition-all duration-200 border-t-2 border-gray-600 group-hover:w-full ease"></span>
<span className="absolute bottom-0 right-0 w-0 h-0 transition-all duration-200 border-b-2 border-gray-600 group-hover:w-full ease"></span>
<span className="absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
<span className="absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
<span className="absolute inset-0 w-full h-full duration-300 delay-300 bg-gray-900 opacity-0 group-hover:opacity-100"></span>
<span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease">Microsoft</span>
</a>
...
<span className="absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
<span className="absolute inset-0 w-full h-full duration-300 delay-300 bg-gray-900 opacity-0 group-hover:opacity-100"></span>
<span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease">Backup</span>
</a>
