...
export const ContactUs = () => {
    const [state, handleSubmit] = useForm("mjvnbjvv");
    return (
        <>
            ...
            <div className="lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">1300 065 248 (13000NK2IT)</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400"> sales@nk2it.com.au</span>
                    </p>
                </div>
      ...
      <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
        ...
        <form className="mt-6" onSubmit={handleSubmit}>
          ...
          <div className="flex-1 mt-6">
            ...
            <input
              type="email"
              name="email"  // Add the name attribute for Formspree
          ...
          <div className="w-full mt-6">
            ...
            <textarea
              name="message"  // Add the name attribute for Formspree
