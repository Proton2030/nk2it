      ...
      <div className='w-full mx-auto px-6 md:px-12 xl:px-6'>
        <div className="relative pt-36 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            <h1 className="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl " >Shaping a world with <span className="text-gray-700 dark:text-white">reimagination.</span></h1>
