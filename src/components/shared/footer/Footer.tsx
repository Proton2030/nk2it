...
/>
          ...
          NK2IT PTY LTD is a leading Sydney-based systems integrator (SI) and ICT consultancy provider for SMBs
          </p>
  ...
  <li>
            <a
  href="https://www.youtube.com/channel/UCh4N21Ne9f5sLE1Cziuas8A"
  rel="noreferrer"
  target="_blank"
...
<li>
            <a
  href="https://www.linkedin.com/company/nk2it/"
  rel="noreferrer"
  target="_blank"
  className="text-red-500 transition hover:opacity-75"
>
  ...
  />
    ...
    <p>1300 065 248 (13000NK2IT)</p>
    <p>Email: sales@nk2it.com.au</p>
  </address>
          </div>
        </div>
      </div>
